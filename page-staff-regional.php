<?php
/*
Template Name: IES Staff Regional Managers Page
*/
...
<div id="main-content">
	<div class="container">
		<div id="content-area" class="clearfix">
			<div id="left-area">
			<article>
				<h1 class="main_title">IES Regional Managers</h1>
							...
							<ul class="ies_staff-list">
								<?php while( $the_query->have_posts() ) : $the_query->the_post(); ?>
									<li>
							        	...
							        	<sup><?php echo get_the_term_list( $post->ID, 'location', 'Service Areas: ', ', ', '' ); ?></sup>
									</li>
								<?php endwhile; ?>
							</ul>
						<?php endif; ?>
